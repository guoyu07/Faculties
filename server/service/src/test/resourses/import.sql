CREATE INDEX GROUPS_ID_index ON PUBLIC.GROUPS (ID);
CREATE INDEX GROUPS_SUBJECTS_GROUPS_ID_index ON PUBLIC.GROUPS_SUBJECTS (GROUPS_ID);
CREATE INDEX USER_INFORMATION_ID_index ON PUBLIC.USER_INFORMATION (ID);
CREATE INDEX USER_INFORMATION_NICKNAME_index ON PUBLIC.USER_INFORMATION (NICKNAME);
CREATE INDEX USER_INFORMATION_EMAIL_index ON PUBLIC.USER_INFORMATION (EMAIL);
CREATE INDEX USERS_ID_index ON PUBLIC.USERS (ID);
CREATE INDEX USERS_SUBJECTS_USERS_ID_index ON PUBLIC.USERS_SUBJECTS (USERS_ID);
CREATE INDEX SUBJECTS_ID_index ON PUBLIC.SUBJECTS (ID);
...
INSERT INTO groups(id,ENROLL_MARK, COUNT_OF_USERS,COUNT_OF_ALL_USERS,INFORMATION,VALID_TILL,COUNT,ISSUE_DATE, FACULTIES_ID) VALUES (1,0,1,1, 'group №1', '2017-12-12', 3, '2018-12-12',1);
INSERT INTO groups(id,ENROLL_MARK, COUNT_OF_USERS,COUNT_OF_ALL_USERS,INFORMATION,VALID_TILL,COUNT,ISSUE_DATE,FACULTIES_ID)  VALUES (2,0,1,1, 'group №2', '2017-12-12', 3, '2018-12-12',1);
INSERT INTO groups(id,ENROLL_MARK, COUNT_OF_USERS,COUNT_OF_ALL_USERS,INFORMATION,VALID_TILL,COUNT,ISSUE_DATE, FACULTIES_ID)  VALUES (3,0,1,1, 'group №3', '2017-12-12', 3, '2018-12-12',1);
