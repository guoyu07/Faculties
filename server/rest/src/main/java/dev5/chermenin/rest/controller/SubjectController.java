...
@Api(description = "Subject controller", authorizations = {@Authorization(value = "basicAuth")})
public class SubjectController {
    ...
    @ApiOperation(value = "save new subject", authorizations = {@Authorization(value = "basicAuth")})
    ...
    @ApiOperation(value = "get all subjects", authorizations = {@Authorization(value = "basicAuth")})
    ...
    @ApiOperation(value = "remove subject", authorizations = {@Authorization(value = "basicAuth")})
    ...
    @ApiOperation(value = "find subject by id", authorizations = {@Authorization(value = "basicAuth")})
    ...
    @ApiOperation(value = "find subject by name", authorizations = {@Authorization(value = "basicAuth")})
    ...
    @ApiOperation(value = "addSubjectToUser", authorizations = {@Authorization(value = "basicAuth")})
    ...
    @ApiOperation(value = "removeUserSubject", authorizations = {@Authorization(value = "basicAuth")})
